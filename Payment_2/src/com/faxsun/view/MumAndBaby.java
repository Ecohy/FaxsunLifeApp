...
public class MumAndBaby extends ListActivity{
	
	catogory_id_type c = catogory_id_type.MUM_AND_BABY;
	...
	protected String TAG = "MumAndBaby";
    ...
    public void onCreate(Bundle savedInstanceState) {  
        ...
        lv = getListView();
		adapter = new CategoryListAdapter(MumAndBaby.this,l);
